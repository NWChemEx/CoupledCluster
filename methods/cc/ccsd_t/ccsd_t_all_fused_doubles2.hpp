...
// singles data driver
template<typename T>
void ccsd_t_data_d2(ExecutionContext& ec, const TiledIndexSpace& MO, const Index noab,
                    ...
                    std::vector<T>& k_abuf2, std::vector<T>& k_bbuf2, std::vector<int>& d2_flags,
                    std::vector<int>& d2_sizes, T* T_d2_t2, T* T_d2_v2,
                    std::vector<int>& sd_t_d2_exec, std::vector<int>& d2_sizes_ext,
                    // std::vector<size_t>& sd_t_d2_exec, std::vector<size_t>& d2_sizes_ext,
                    bool is_restricted, LRUCache<Index, std::vector<T>>& cache_d2t,
