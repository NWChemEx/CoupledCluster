...
// singles data driver
template<typename T>
void ccsd_t_data_s1(ExecutionContext& ec, const TiledIndexSpace& MO, const Index noab,
                    ...
                    //
                    std::vector<int>& s1_flags, std::vector<int>& s1_sizes, T* T_s1_t1, T* T_s1_v2,
                    //
  ...
  for(auto ia6 = 0; ia6 < 9; ia6++) {
    ...
    if(ref_p456_h123 == cur_p456_h123) { sd_t_s1_exec[ia6 * 9 + 0] = s1b++; }
    if(ref_p456_h123 == cur_p456_h213) { sd_t_s1_exec[ia6 * 9 + 1] = s1b++; }
    if(ref_p456_h123 == cur_p456_h231) { sd_t_s1_exec[ia6 * 9 + 2] = s1b++; }
    if(ref_p456_h123 == cur_p546_h123) { sd_t_s1_exec[ia6 * 9 + 3] = s1b++; }
    if(ref_p456_h123 == cur_p546_h213) { sd_t_s1_exec[ia6 * 9 + 4] = s1b++; }
    if(ref_p456_h123 == cur_p546_h231) { sd_t_s1_exec[ia6 * 9 + 5] = s1b++; }
    if(ref_p456_h123 == cur_p564_h123) { sd_t_s1_exec[ia6 * 9 + 6] = s1b++; }
    if(ref_p456_h123 == cur_p564_h213) { sd_t_s1_exec[ia6 * 9 + 7] = s1b++; }
    if(ref_p456_h123 == cur_p564_h231) { sd_t_s1_exec[ia6 * 9 + 8] = s1b++; }
  } // end ia6
