...
// template<typename T>
using T = double;
void ccsd_t_singles_unfused(ExecutionContext& ec, const TiledIndexSpace& MO, const Index noab,
                            const Index nvab, std::vector<int>& k_spin, std::vector<T>& a_c,
                            Tensor<T>& d_t1, Tensor<T>& d_v2, std::vector<T>& p_evl_sorted,
      ...
      if((!is_restricted) ||
        ...
        if(k_spin[p4b] + k_spin[p5b] + k_spin[p6b] == k_spin[h1b] + k_spin[h2b] + k_spin[h3b]) {
          if(k_spin[p4b] == k_spin[h1b]) {
            ...
            if(dima > 0 && dimb > 0) {
              //  cout << "spin1,2 = ";
              //  print_varlist(k_spin[p4b]+k_spin[p5b]+k_spin[p6b],
              ...
              if((t_p4b == p4b) && (t_p5b == p5b) && (t_p6b == p6b) && (t_h1b == h1b) &&
                ...
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_1_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_1(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_1_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }
              ...
              if((t_p4b == p4b) && (t_p5b == p5b) && (t_p6b == p6b) && (t_h1b == h2b) &&
                ...
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_2_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_2(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_2_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }
              ...
              if((t_p4b == p4b) && (t_p5b == p5b) && (t_p6b == p6b) && (t_h1b == h2b) &&
                ...
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_3_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_3(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_3_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }
              ...
              if((t_p4b == p5b) && (t_p5b == p4b) && (t_p6b == p6b) && (t_h1b == h1b) &&
                ...
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_4_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_4(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_4_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }

              if((t_p4b == p5b) && (t_p5b == p4b) && (t_p6b == p6b) && (t_h1b == h2b) &&
                 (t_h2b == h1b) && (t_h3b == h3b)) {
                // print_varlist(5);
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_5_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_5(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_5_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }
              ...
              if((t_p4b == p5b) && (t_p5b == p4b) && (t_p6b == p6b) && (t_h1b == h2b) &&
                ...
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_6_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_6(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_6_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }
              ...
              if((t_p4b == p5b) && (t_p5b == p6b) && (t_p6b == p4b) && (t_h1b == h1b) &&
                ...
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_7_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_7(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_7_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }

              if((t_p4b == p5b) && (t_p5b == p6b) && (t_p6b == p4b) && (t_h1b == h2b) &&
                 (t_h2b == h1b) && (t_h3b == h3b)) {
                // print_varlist(8);
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_8_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_8(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_8_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }
              ...
              if((t_p4b == p5b) && (t_p5b == p6b) && (t_p6b == p4b) && (t_h1b == h2b) &&
                ...
                if(has_gpu) {
                  if(use_nwc_gpu_kernels)
                    sd_t_s1_9_cuda(k_range[h1b], k_range[h2b], k_range[h3b], k_range[p4b],
                                   k_range[p5b], k_range[p6b], &a_c[0], &k_a_sort[0], &k_b_sort[0]);
#if defined(USE_CUDA)
                  else
                    jk_ccsd_t_s1_9(k_range[t_h3b], k_range[t_h2b], k_range[t_h1b], k_range[t_p6b],
                                   k_range[t_p5b], k_range[t_p4b], &a_c[0], &k_a_sort[0],
                                   &k_b_sort[0]);
#endif
                }
                else
                  sd_t_s1_9_cpu(k_range[t_h1b], k_range[t_h2b], k_range[t_h3b], k_range[t_p4b],
                                k_range[t_p5b], k_range[t_p6b], &a_c[0], &k_a_sort[0],
                                &k_b_sort[0]);
              }
