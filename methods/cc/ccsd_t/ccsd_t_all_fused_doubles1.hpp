...
// singles data driver
template<typename T>
void ccsd_t_data_d1(ExecutionContext& ec, const TiledIndexSpace& MO, const Index noab,
                    ...
                    //
                    std::vector<int>& d1_flags, std::vector<int>& d1_sizes, T* T_d1_t2, T* T_d1_v2,
                    //
                    std::vector<int>& sd_t_d1_exec, std::vector<int>& d1_sizes_ext,
                    // std::vector<size_t>& sd_t_d1_exec, std::vector<size_t>& d1_sizes_ext,
                    bool is_restricted, LRUCache<Index, std::vector<T>>& cache_d1t,
  ...
  for(auto ia6 = 0; ia6 < 9; ia6++) {
    ...
    for(Index h7b = 0; h7b < noab; h7b++) {
      ...
      if(ref_p456_h123 == cur_p456_h123) { sd_t_d1_exec[0 + (h7b + (ia6) *noab) * 9] = d1b++; }
      if(ref_p456_h123 == cur_p456_h213) { sd_t_d1_exec[1 + (h7b + (ia6) *noab) * 9] = d1b++; }
      if(ref_p456_h123 == cur_p456_h231) { sd_t_d1_exec[2 + (h7b + (ia6) *noab) * 9] = d1b++; }
      if(ref_p456_h123 == cur_p645_h123) { sd_t_d1_exec[3 + (h7b + (ia6) *noab) * 9] = d1b++; }
      if(ref_p456_h123 == cur_p645_h213) { sd_t_d1_exec[4 + (h7b + (ia6) *noab) * 9] = d1b++; }
      if(ref_p456_h123 == cur_p645_h231) { sd_t_d1_exec[5 + (h7b + (ia6) *noab) * 9] = d1b++; }
      if(ref_p456_h123 == cur_p465_h123) { sd_t_d1_exec[6 + (h7b + (ia6) *noab) * 9] = d1b++; }
      if(ref_p456_h123 == cur_p465_h213) { sd_t_d1_exec[7 + (h7b + (ia6) *noab) * 9] = d1b++; }
      if(ref_p456_h123 == cur_p465_h231) { sd_t_d1_exec[8 + (h7b + (ia6) *noab) * 9] = d1b++; }
    } // h7b
  }   // end ia6
